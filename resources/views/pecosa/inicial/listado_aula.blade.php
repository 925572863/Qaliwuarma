        ...
        <table class="w-full text-xs border-collapse" id="tabla-listado">
            <thead>
                ...
                <tr>
                    <th rowspan="2" colspan="2"
                        class="border-2 border-gray-700 bg-orange-300 text-gray-800 font-bold text-center px-2 py-2 uppercase text-xs">
                    ...
                    <th rowspan="2"
                        class="border-2 border-gray-700 bg-orange-300 text-gray-800 font-bold text-center px-2 py-2 uppercase text-[10px]">
                        Nº<br>BOLSAS
                    </th>
                </tr>
                ...
                <tr>
                    @foreach($productos as $prod)
                        <th class="border border-gray-500 bg-orange-200 text-gray-800 font-bold text-center px-1 py-1 text-[8px] uppercase leading-tight max-w-[50px]">
                            {{ $prod['nombre'] }}<br>
            ...
            <tbody>
                @foreach($alumnos as $i => $alumno)
                    ...
                    @endphp
                    <tr class="{{ $esUltimo ? 'bg-orange-50 font-semibold' : ($i % 2 === 0 ? 'bg-white' : 'bg-gray-50') }}">

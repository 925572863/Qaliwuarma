...
@section('breadcrumb', $alumno->nombre_completo . ' · ' . $alumno->matricula)

@section('content')
<div class="max-w-4xl">
    <form method="POST" action="{{ route('alumnos.update', $alumno) }}" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="px-6 py-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="direccion" rows="2"
                              class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none">{{ old('direccion', $alumno->direccion) }}</textarea>
                </div>
            ...
            <div class="px-6 py-5 grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <select name="nivel"
                        ...
                        <option value="inicial"  {{ old('nivel', $alumno->nivel) === 'inicial'  ? 'selected' : '' }}>Inicial</option>
                ...
                <div>
                    ...
                    <select name="semestre"
                        ...
                        @for($i = 1; $i <= 12; $i++)
                            <option value="{{ $i }}" {{ old('semestre', $alumno->semestre) == $i ? 'selected' : '' }}>
                                {{ $i }}° Semestre
                            </option>
                        @endfor
                    </select>
                ...
                <div>
                    ...
                    <select name="estado"
                        ...
                        <option value="inactivo" {{ old('estado', $alumno->estado) === 'inactivo' ? 'selected' : '' }}>Trasladado</option>
                ...
                <div class="md:col-span-3">
                    ...
                    <textarea name="observaciones" rows="3"
                              class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none">{{ old('observaciones', $alumno->observaciones) }}</textarea>
                </div>

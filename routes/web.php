...
// TEMPORAL: verificar la suma total de productos de Pecosa Inicial (mas reciente).
Route::get('/check-suma-inicial/{token}', function (string $token) {
    if (! hash_equals('53ad73091360d1a58220bcb870c751933876ba15589fc9e9', $token)) {
        abort(404);
    }
    $pecosaMasReciente = \Illuminate\Support\Facades\DB::table('pecosa_inicial')
